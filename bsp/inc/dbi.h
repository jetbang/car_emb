...
#define DBI_IT_CONFIG(IT,CMD) USART_ITConfig(DBI_USART, IT, CMD)
#define DBI_ENABLE_IT_TXE() DBI_IT_CONFIG(USART_IT_TXE, ENABLE)
#define DBI_DISABLE_IT_TXE() DBI_IT_CONFIG(USART_IT_TXE, DISABLE)
#define DBI_ENABLE_IT_RXNE() DBI_IT_CONFIG(USART_IT_RXNE, ENABLE)
#define DBI_DISABLE_IT_RXNE() DBI_IT_CONFIG(USART_IT_RXNE, DISABLE)
#define DBI_ENABLE_IT_IDLE() DBI_IT_CONFIG(USART_IT_IDLE, ENABLE)
#define DBI_DISABLE_IT_IDLE() DBI_IT_CONFIG(USART_IT_IDLE, DISABLE)

#define DBI_IRQ_HANDLER IRQ_HANDLER(USART3)
#define DBI_NVIC IRQ(USART3)
#define DBI_NVIC_PRE_PRIORITY 0
