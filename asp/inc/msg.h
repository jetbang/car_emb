...
#define ODOM_MSG_VALUE_SCALE 1e3f
typedef struct
{
	uint32_t frame_id;
...
#define GIM_MSG_VALUE_SCALE 1e3f
typedef struct
{
	uint32_t frame_id;
	int16_t pp; // Pan position
	int16_t vp; // Pan velocity
	int16_t pt; // Tilt position
	int16_t vt; // Titl velocity
}GimMsg_t;
...
#define SONAR_DATA_SIZE 1
typedef struct
{
	uint32_t frame_id;
	uint16_t data[SONAR_DATA_SIZE];
}SonarMsg_t;

#define CBUS_MSG_VALUE_SCALE CBUS_VALUE_SCALE
#define CBUS_MSG_FLAG_BIT_INI (1u<<31u)
#define CBUS_MSG_FLAG_BIT_MOD (1u<<30u)
typedef struct
{
	uint32_t frame_id;
	CBUS_t data;
...
#define MSG_ID_RCP WRAP_U8(0x01)
#define MSG_ID_HCP WRAP_U8(0x02)
#define MSG_ID_IMU WRAP_U8(0x03)
#define MSG_ID_MAG WRAP_U8(0x04)
#define MSG_ID_GIM WRAP_U8(0x05)
#define MSG_ID_ODOM WRAP_U8(0x06)
#define MSG_ID_DBUS WRAP_U8(0x07)
#define MSG_ID_CBUS WRAP_U8(0x08)
#define MSG_ID_ZGYRO WRAP_U8(0x09)
#define MSG_ID_MOTOR WRAP_U8(0x0a)
#define MSG_ID_STATU WRAP_U8(0x0b)
#define MSG_ID_SUBSC WRAP_U8(0x0c)
#define MSG_ID_CALIB WRAP_U8(0x0d)
...
#define MSG_LEN_GIM sizeof(GimMsg_t)
#define MSG_LEN_ODOM sizeof(OdomMsg_t)
...
#define MSG_TOKEN_RCP WRAP_U16(0x1234)
#define MSG_TOKEN_HCP WRAP_U16(0x2345)
#define MSG_TOKEN_IMU WRAP_U16(0x3456)
#define MSG_TOKEN_MAG WRAP_U16(0x4567)
#define MSG_TOKEN_GIM WRAP_U16(0x5678)
#define MSG_TOKEN_ODOM WRAP_U16(0x6789)
#define MSG_TOKEN_DBUS WRAP_U16(0x789a)
#define MSG_TOKEN_CBUS WRAP_U16(0x89ab)
#define MSG_TOKEN_ZGYRO WRAP_U16(0x9abc)
#define MSG_TOKEN_MOTOR WRAP_U16(0xabcd)
#define MSG_TOKEN_STATU WRAP_U16(0xbcde)
#define MSG_TOKEN_SUBSC WRAP_U16(0xcdef)
#define MSG_TOKEN_CALIB WRAP_U16(0xfedc)
...
#define MSG_HEAD_VALUE_GIM MSG_HEAD_VALUE_OF(GIM)
#define MSG_HEAD_VALUE_ODOM MSG_HEAD_VALUE_OF(ODOM)
...
#define MSG_HEAD_IMU { MSG_HEAD_VALUE_IMU }
#define MSG_HEAD_MAG { MSG_HEAD_VALUE_MAG }
#define MSG_HEAD_GIM { MSG_HEAD_VALUE_GIM }
#define MSG_HEAD_ODOM { MSG_HEAD_VALUE_ODOM }
...
typedef enum
{
	...
	MSG_TYPE_GIM = 1u << MSG_TYPE_IDX_GIM,
	MSG_TYPE_ODOM = 1u << MSG_TYPE_IDX_ODOM,
...
const MsgHead_t msg_head_rcp;
const MsgHead_t msg_head_hcp;
const MsgHead_t msg_head_odom;
const MsgHead_t msg_head_dbus;
const MsgHead_t msg_head_cbus;
