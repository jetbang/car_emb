...
#define WDG_OVERFLOW_CNT_RCV   	    WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_TTY  		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_BTM  		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_DBI  		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_IMU  		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_VRC  		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_VHC  		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_VDBUS      WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_CBUS  	    WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_CALIB  	WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_ZGYRO 		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_MOTOR 		WDG_CNT_CVT(200u)
#define WDG_OVERFLOW_CNT_JUDSYS 	WDG_CNT_CVT(200u)
